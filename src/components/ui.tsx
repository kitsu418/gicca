// Small, opinionated UI primitives reused across pages. Intentionally
// minimal — Tailwind v4 utility classes do the heavy lifting and any
// real styling lives at the call site.
...
export function Screen({ children, className = '' }: { children: ReactNode; className?: string }) {
  return (
    <div className={`min-h-dvh bg-slate-950 text-slate-100 ${className}`}>{children}</div>
  );
}
